if (window.localStorage.getItem("allow_css")){
    ...
    document.documentElement.innerHTML = "<div style='text-align:center;'><h1>Site is highly <span style='color:red'>Unsafe</span></h1>  <button id='button' ><h3>Click here to continue</h3></buttonid></div>";
